 ...
 */
  __po_hi_create_sporadic_task (gr740_partition_receiver_image_k, &(period), 1, 50000, 0, receiver_image_job);
 ...
 */
  __po_hi_create_periodic_task (gr740_partition_sender_trigger_k, &(period), 1, 50000, 0, sender_trigger_job);
