 ...
 */
  __po_hi_create_sporadic_task (gr740_partition_receiver_image_k, &(period), 1, 13000000, 0, receiver_image_job);
 ...
 *  ( 13000000 bytes) and last is the subprogram executed by the task
 */
  __po_hi_create_periodic_task (gr740_partition_sender_trigger_k, &(period), 1, 13000000, 0, sender_trigger_job);
