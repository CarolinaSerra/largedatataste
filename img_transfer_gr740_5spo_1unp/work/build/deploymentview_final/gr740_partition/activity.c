...
__po_hi_port_t __po_hi_receiver_a_outport_receiver_c_local_destinations[1] = {receiver_c_global_inport_c};
...
__po_hi_port_id_t __po_hi_receiver_a_n_dest[__po_hi_receiver_a_nb_ports] = {0,1,1,1,1,1};
__po_hi_port_id_t __po_hi_receiver_a_fifo_size[__po_hi_receiver_a_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_receiver_a_destinations[__po_hi_receiver_a_nb_ports] = {NULL,__po_hi_receiver_a_outport_receiver_a_local_destinations,__po_hi_receiver_a_outport_receiver_c_local_destinations,__po_hi_receiver_a_outport_receiver_image_local_destinations,__po_hi_receiver_a_outport_sender_b_local_destinations,__po_hi_receiver_a_outport_sender_testint_local_destinations};
...
__po_hi_port_t __po_hi_receiver_c_outport_receiver_a_local_destinations[1] = {receiver_a_global_inport_a};
__po_hi_port_t __po_hi_receiver_c_outport_receiver_c_local_destinations[1] = {receiver_c_global_inport_c};
__po_hi_port_t __po_hi_receiver_c_outport_receiver_image_local_destinations[1] = {receiver_image_global_inport_image};
...
__po_hi_port_id_t __po_hi_receiver_c_n_dest[__po_hi_receiver_c_nb_ports] = {0,1,1,1,1,1};
__po_hi_port_id_t __po_hi_receiver_c_fifo_size[__po_hi_receiver_c_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_receiver_c_destinations[__po_hi_receiver_c_nb_ports] = {NULL,__po_hi_receiver_c_outport_receiver_a_local_destinations,__po_hi_receiver_c_outport_receiver_c_local_destinations,__po_hi_receiver_c_outport_receiver_image_local_destinations,__po_hi_receiver_c_outport_sender_b_local_destinations,__po_hi_receiver_c_outport_sender_testint_local_destinations};
...
__po_hi_port_t __po_hi_receiver_image_outport_receiver_c_local_destinations[1] = {receiver_c_global_inport_c};
...
__po_hi_port_id_t __po_hi_receiver_image_n_dest[__po_hi_receiver_image_nb_ports] = {0,1,1,1,1,1};
__po_hi_port_id_t __po_hi_receiver_image_fifo_size[__po_hi_receiver_image_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_receiver_image_destinations[__po_hi_receiver_image_nb_ports] = {NULL,__po_hi_receiver_image_outport_receiver_a_local_destinations,__po_hi_receiver_image_outport_receiver_c_local_destinations,__po_hi_receiver_image_outport_receiver_image_local_destinations,__po_hi_receiver_image_outport_sender_b_local_destinations,__po_hi_receiver_image_outport_sender_testint_local_destinations};
