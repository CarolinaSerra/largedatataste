 ...
 */
  __po_hi_create_sporadic_task (x86_partition_receiver_image_k, &(period), 1, 50000000, 0, receiver_image_job);
 ...
 * (x86_partition_sender_trigger_k) the second is the period defined in the 
 * AADL model. Third is the task priority ( 1), fourth is the stack size ( 
 * 50000000 bytes) and last is the subprogram executed by the task
 */
  __po_hi_create_periodic_task (x86_partition_sender_trigger_k, &(period), 1, 50000000, 0, sender_trigger_job);
