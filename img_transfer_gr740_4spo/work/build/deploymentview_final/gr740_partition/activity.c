...
__po_hi_port_id_t __po_hi_receiver_a_n_dest[__po_hi_receiver_a_nb_ports] = {0,1,1};
__po_hi_port_id_t __po_hi_receiver_a_fifo_size[__po_hi_receiver_a_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_receiver_a_destinations[__po_hi_receiver_a_nb_ports] = {NULL,__po_hi_receiver_a_outport_sender_b_local_destinations,__po_hi_receiver_a_outport_sender_testint_local_destinations};
...
__po_hi_port_id_t __po_hi_receiver_image_n_dest[__po_hi_receiver_image_nb_ports] = {0,1,1};
__po_hi_port_id_t __po_hi_receiver_image_fifo_size[__po_hi_receiver_image_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_receiver_image_destinations[__po_hi_receiver_image_nb_ports] = {NULL,__po_hi_receiver_image_outport_sender_b_local_destinations,__po_hi_receiver_image_outport_sender_testint_local_destinations};
...
__po_hi_port_id_t __po_hi_sender_b_n_dest[__po_hi_sender_b_nb_ports] = {0,1,1};
__po_hi_port_id_t __po_hi_sender_b_fifo_size[__po_hi_sender_b_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_sender_b_destinations[__po_hi_sender_b_nb_ports] = {NULL,__po_hi_sender_b_outport_receiver_a_local_destinations,__po_hi_sender_b_outport_receiver_image_local_destinations};
...
__po_hi_port_id_t __po_hi_sender_testint_n_dest[__po_hi_sender_testint_nb_ports] = {0,1,1};
__po_hi_port_id_t __po_hi_sender_testint_fifo_size[__po_hi_sender_testint_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_sender_testint_destinations[__po_hi_sender_testint_nb_ports] = {NULL,__po_hi_sender_testint_outport_receiver_a_local_destinations,__po_hi_sender_testint_outport_receiver_image_local_destinations};
...
__po_hi_port_id_t __po_hi_sender_trigger_n_dest[__po_hi_sender_trigger_nb_ports] = {1,1};
__po_hi_port_id_t __po_hi_sender_trigger_fifo_size[__po_hi_sender_trigger_nb_ports] = {__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_sender_trigger_destinations[__po_hi_sender_trigger_nb_ports] = {__po_hi_sender_trigger_outport_receiver_a_local_destinations,__po_hi_sender_trigger_outport_receiver_image_local_destinations};
