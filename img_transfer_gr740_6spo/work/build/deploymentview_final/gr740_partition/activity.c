...
__po_hi_port_t __po_hi_receiver_a_outport_sender_d_local_destinations[1] = {sender_d_global_inport_d};
...
__po_hi_port_id_t __po_hi_receiver_a_n_dest[__po_hi_receiver_a_nb_ports] = {0,1,1,1};
__po_hi_port_id_t __po_hi_receiver_a_fifo_size[__po_hi_receiver_a_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_receiver_a_destinations[__po_hi_receiver_a_nb_ports] = {NULL,__po_hi_receiver_a_outport_sender_b_local_destinations,__po_hi_receiver_a_outport_sender_d_local_destinations,__po_hi_receiver_a_outport_sender_testint_local_destinations};
 ...
 */
  while (1)
  {
    ...
    (void)error;
    error =
     __po_hi_send_output (gr740_partition_receiver_a_k, receiver_a_global_outport_sender_d);
    (void)error;
    error =
...
__po_hi_port_t __po_hi_receiver_c_outport_sender_b_local_destinations[1] = {sender_b_global_inport_b};
__po_hi_port_t __po_hi_receiver_c_outport_sender_d_local_destinations[1] = {sender_d_global_inport_d};
__po_hi_port_t __po_hi_receiver_c_outport_sender_testint_local_destinations[1] = {sender_testint_global_inport_testint};
__po_hi_port_id_t __po_hi_receiver_c_woffsets[__po_hi_receiver_c_nb_ports];
__po_hi_port_id_t __po_hi_receiver_c_offsets[__po_hi_receiver_c_nb_ports];
__po_hi_port_id_t __po_hi_receiver_c_used_size[__po_hi_receiver_c_nb_ports];
__po_hi_port_id_t __po_hi_receiver_c_empties[__po_hi_receiver_c_nb_ports];
__po_hi_port_id_t __po_hi_receiver_c_first[__po_hi_receiver_c_nb_ports];
__po_hi_request_t *__po_hi_receiver_c_recent[__po_hi_receiver_c_nb_ports];
__po_hi_request_t *__po_hi_receiver_c_queue[1];
__po_hi_uint16_t __po_hi_receiver_c_total_fifo_size = 1;
__po_hi_local_port_t __po_hi_receiver_c_history[1];
__po_hi_port_id_t __po_hi_receiver_c_n_dest[__po_hi_receiver_c_nb_ports] = {0,1,1,1};
__po_hi_port_id_t __po_hi_receiver_c_fifo_size[__po_hi_receiver_c_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_receiver_c_destinations[__po_hi_receiver_c_nb_ports] = {NULL,__po_hi_receiver_c_outport_sender_b_local_destinations,__po_hi_receiver_c_outport_sender_d_local_destinations,__po_hi_receiver_c_outport_sender_testint_local_destinations};

/*!
 * \fn void receiver_c_deliver (__po_hi_request_t* request)
 * \brief Function that delivers requests to the task receiver_c
 *
 * When the generated application received a request, it calls a main delivery
 *  function that redirects to localfunctions for each task. This function 
 * (receiver_c_deliver) stores the incoming request for the taskreceiver_c
 */
    ...
    (__po_hi_request_t* request)
{
  ...
  switch (request->port)
  {
    ...
    {
      __po_hi_gqueue_store_in (gr740_partition_receiver_c_k, receiver_c_local_inport_c, request);
...
/*!
 * \fn void* receiver_c_job (void)
 * \brief Function executed by the task receiver_c
 *
 * This function is executed as soon as the task  is created. It performs the 
 * following operations:  Receive incoming data,  Execute tasks subprograms,  
 * Send output data.
 */
/*  Sporadic task : receiver_c */
extern void call_receiver_c 
    (__po_hi_task_id self,
    dataview__myinteger_buffer_impl* inport_c);
extern void init_receiver (void);
void* receiver_c_job (void)
{
  __po_hi_local_port_t port;
  __po_hi_request_t *inport_c_request;
  __po_hi_int32_t error;
 ...
 */
  __po_hi_wait_initialization ();
  __po_hi_compute_next_period (gr740_partition_receiver_c_k);
  
/*!
 * Waiting for the first dispatch instant
 */
  __po_hi_wait_for_next_period (gr740_partition_receiver_c_k);
 ...
 */
  while (1)
  {
    __po_hi_gqueue_wait_for_incoming_event (gr740_partition_receiver_c_k, &(port));
    __po_hi_compute_next_period (gr740_partition_receiver_c_k);
    /*  Make_Ports_Compute_Entrypoint */
    switch (port)
    {
      case receiver_c_local_inport_c:
      {
        /* :: Yes if commentary :: */
        if (__po_hi_gqueue_get_count (gr740_partition_receiver_c_k, receiver_c_local_inport_c))
        {
                  __po_hi_gqueue_get_value (gr740_partition_receiver_c_k, receiver_c_local_inport_c, &(inport_c_request));
          __po_hi_gqueue_next_value (gr740_partition_receiver_c_k, receiver_c_local_inport_c);

        }

        call_receiver_c (gr740_partition_receiver_c_k, &(inport_c_request->vars.receiver_c_global_inport_c.receiver_c_global_inport_c));
    ...
    (void)error;
    error =
     __po_hi_send_output (gr740_partition_receiver_c_k, receiver_c_global_outport_sender_d);
    (void)error;
    error =
     __po_hi_send_output (gr740_partition_receiver_c_k, receiver_c_global_outport_sender_testint);
    (void)error;
    __po_hi_free_request (inport_c_request);
    __po_hi_wait_for_next_period (gr740_partition_receiver_c_k);
  }
}

__po_hi_port_t __po_hi_receiver_image_outport_sender_b_local_destinations[1] = {sender_b_global_inport_b};
__po_hi_port_t __po_hi_receiver_image_outport_sender_d_local_destinations[1] = {sender_d_global_inport_d};
...
__po_hi_port_id_t __po_hi_receiver_image_n_dest[__po_hi_receiver_image_nb_ports] = {0,1,1,1};
__po_hi_port_id_t __po_hi_receiver_image_fifo_size[__po_hi_receiver_image_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_receiver_image_destinations[__po_hi_receiver_image_nb_ports] = {NULL,__po_hi_receiver_image_outport_sender_b_local_destinations,__po_hi_receiver_image_outport_sender_d_local_destinations,__po_hi_receiver_image_outport_sender_testint_local_destinations};
 ...
 */
  while (1)
  {
    ...
    (void)error;
    error =
     __po_hi_send_output (gr740_partition_receiver_image_k, receiver_image_global_outport_sender_d);
    (void)error;
    error =
...
__po_hi_port_t __po_hi_sender_b_outport_receiver_c_local_destinations[1] = {receiver_c_global_inport_c};
...
__po_hi_port_id_t __po_hi_sender_b_n_dest[__po_hi_sender_b_nb_ports] = {0,1,1,1};
__po_hi_port_id_t __po_hi_sender_b_fifo_size[__po_hi_sender_b_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_sender_b_destinations[__po_hi_sender_b_nb_ports] = {NULL,__po_hi_sender_b_outport_receiver_a_local_destinations,__po_hi_sender_b_outport_receiver_c_local_destinations,__po_hi_sender_b_outport_receiver_image_local_destinations};
...
__po_hi_port_t __po_hi_sender_d_outport_receiver_a_local_destinations[1] = {receiver_a_global_inport_a};
__po_hi_port_t __po_hi_sender_d_outport_receiver_c_local_destinations[1] = {receiver_c_global_inport_c};
__po_hi_port_t __po_hi_sender_d_outport_receiver_image_local_destinations[1] = {receiver_image_global_inport_image};
__po_hi_port_id_t __po_hi_sender_d_woffsets[__po_hi_sender_d_nb_ports];
__po_hi_port_id_t __po_hi_sender_d_offsets[__po_hi_sender_d_nb_ports];
__po_hi_port_id_t __po_hi_sender_d_used_size[__po_hi_sender_d_nb_ports];
__po_hi_port_id_t __po_hi_sender_d_empties[__po_hi_sender_d_nb_ports];
__po_hi_port_id_t __po_hi_sender_d_first[__po_hi_sender_d_nb_ports];
__po_hi_request_t *__po_hi_sender_d_recent[__po_hi_sender_d_nb_ports];
__po_hi_request_t *__po_hi_sender_d_queue[1];
__po_hi_uint16_t __po_hi_sender_d_total_fifo_size = 1;
__po_hi_local_port_t __po_hi_sender_d_history[1];
__po_hi_port_id_t __po_hi_sender_d_n_dest[__po_hi_sender_d_nb_ports] = {0,1,1,1};
__po_hi_port_id_t __po_hi_sender_d_fifo_size[__po_hi_sender_d_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_sender_d_destinations[__po_hi_sender_d_nb_ports] = {NULL,__po_hi_sender_d_outport_receiver_a_local_destinations,__po_hi_sender_d_outport_receiver_c_local_destinations,__po_hi_sender_d_outport_receiver_image_local_destinations};

/*!
 * \fn void sender_d_deliver (__po_hi_request_t* request)
 * \brief Function that delivers requests to the task sender_d
 *
 * When the generated application received a request, it calls a main delivery
 *  function that redirects to localfunctions for each task. This function 
 * (sender_d_deliver) stores the incoming request for the tasksender_d
 */
    ...
    (__po_hi_request_t* request)
{
  ...
  switch (request->port)
  {
    ...
    {
      __po_hi_gqueue_store_in (gr740_partition_sender_d_k, sender_d_local_inport_d, request);
...
/*!
 * \fn void* sender_d_job (void)
 * \brief Function executed by the task sender_d
 *
 * This function is executed as soon as the task  is created. It performs the 
 * following operations:  Receive incoming data,  Execute tasks subprograms,  
 * Send output data.
 */
/*  Sporadic task : sender_d */
extern void call_sender_d 
    (__po_hi_task_id self,
    dataview__myinteger_buffer_impl* inport_d);
extern void init_sender (void);
void* sender_d_job (void)
{
  __po_hi_local_port_t port;
  __po_hi_request_t *inport_d_request;
  __po_hi_int32_t error;
 ...
 */
  __po_hi_wait_initialization ();
  __po_hi_compute_next_period (gr740_partition_sender_d_k);
  
/*!
 * Waiting for the first dispatch instant
 */
  __po_hi_wait_for_next_period (gr740_partition_sender_d_k);
 ...
 */
  while (1)
  {
    __po_hi_gqueue_wait_for_incoming_event (gr740_partition_sender_d_k, &(port));
    __po_hi_compute_next_period (gr740_partition_sender_d_k);
    /*  Make_Ports_Compute_Entrypoint */
    switch (port)
    {
      case sender_d_local_inport_d:
      {
        /* :: Yes if commentary :: */
        if (__po_hi_gqueue_get_count (gr740_partition_sender_d_k, sender_d_local_inport_d))
        {
                  __po_hi_gqueue_get_value (gr740_partition_sender_d_k, sender_d_local_inport_d, &(inport_d_request));
          __po_hi_gqueue_next_value (gr740_partition_sender_d_k, sender_d_local_inport_d);

        }

        call_sender_d (gr740_partition_sender_d_k, &(inport_d_request->vars.sender_d_global_inport_d.sender_d_global_inport_d));
    ...
    /*  Send the OUT ports */
    error =
     __po_hi_send_output (gr740_partition_sender_d_k, sender_d_global_outport_receiver_a);
    (void)error;
    error =
     __po_hi_send_output (gr740_partition_sender_d_k, sender_d_global_outport_receiver_c);
    (void)error;
    error =
     __po_hi_send_output (gr740_partition_sender_d_k, sender_d_global_outport_receiver_image);
    (void)error;
    __po_hi_free_request (inport_d_request);
    __po_hi_wait_for_next_period (gr740_partition_sender_d_k);
  }
}

__po_hi_port_t __po_hi_sender_testint_outport_receiver_a_local_destinations[1] = {receiver_a_global_inport_a};
__po_hi_port_t __po_hi_sender_testint_outport_receiver_c_local_destinations[1] = {receiver_c_global_inport_c};
...
__po_hi_port_id_t __po_hi_sender_testint_n_dest[__po_hi_sender_testint_nb_ports] = {0,1,1,1};
__po_hi_port_id_t __po_hi_sender_testint_fifo_size[__po_hi_sender_testint_nb_ports] = {1,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_sender_testint_destinations[__po_hi_sender_testint_nb_ports] = {NULL,__po_hi_sender_testint_outport_receiver_a_local_destinations,__po_hi_sender_testint_outport_receiver_c_local_destinations,__po_hi_sender_testint_outport_receiver_image_local_destinations};
...
__po_hi_port_t __po_hi_sender_trigger_outport_receiver_c_local_destinations[1] = {receiver_c_global_inport_c};
...
__po_hi_port_id_t __po_hi_sender_trigger_n_dest[__po_hi_sender_trigger_nb_ports] = {1,1,1};
__po_hi_port_id_t __po_hi_sender_trigger_fifo_size[__po_hi_sender_trigger_nb_ports] = {__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT,__PO_HI_GQUEUE_FIFO_OUT};
__po_hi_port_t* __po_hi_sender_trigger_destinations[__po_hi_sender_trigger_nb_ports] = {__po_hi_sender_trigger_outport_receiver_a_local_destinations,__po_hi_sender_trigger_outport_receiver_c_local_destinations,__po_hi_sender_trigger_outport_receiver_image_local_destinations};
    ...
    (__po_hi_request_t* request)
{
  ...
  switch (entity)
  {
    ...
    case gr740_partition_receiver_c_k_entity:
    {
      receiver_c_deliver (request);
    ...
    case gr740_partition_sender_d_k_entity:
    {
      sender_d_deliver (request);
...
void __po_hi_main_initialize (void)
{
  ...
  __po_hi_gqueue_init (gr740_partition_receiver_c_k, __po_hi_receiver_c_nb_ports, __po_hi_receiver_c_queue, __po_hi_receiver_c_fifo_size, __po_hi_receiver_c_first, __po_hi_receiver_c_offsets, __po_hi_receiver_c_woffsets, __po_hi_receiver_c_n_dest, __po_hi_receiver_c_destinations, __po_hi_receiver_c_used_size, __po_hi_receiver_c_history, __po_hi_receiver_c_recent, __po_hi_receiver_c_empties, __po_hi_receiver_c_total_fifo_size);
  ...
  __po_hi_gqueue_init (gr740_partition_sender_d_k, __po_hi_sender_d_nb_ports, __po_hi_sender_d_queue, __po_hi_sender_d_fifo_size, __po_hi_sender_d_first, __po_hi_sender_d_offsets, __po_hi_sender_d_woffsets, __po_hi_sender_d_n_dest, __po_hi_sender_d_destinations, __po_hi_sender_d_used_size, __po_hi_sender_d_history, __po_hi_sender_d_recent, __po_hi_sender_d_empties, __po_hi_sender_d_total_fifo_size);
