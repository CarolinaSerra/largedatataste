...
/*!
 * Store the period time for task receiver_a
 */
 ...
 */
  __po_hi_create_sporadic_task (gr740_partition_receiver_a_k, &(period), 1, 50000, 0, receiver_a_job);
  
/*!
 * Store the period time for task receiver_c
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (gr740_partition_receiver_c_k, &(period), 1, 50000, 0, receiver_c_job);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (gr740_partition_receiver_image_k, &(period), 1, 4500000, 0, receiver_image_job);
  
/*!
 * Store the period time for task sender_b
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (gr740_partition_sender_b_k, &(period), 1, 50000, 0, sender_b_job);
  
/*!
 * Store the period time for task sender_d
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (gr740_partition_sender_d_k, &(period), 1, 50000, 0, sender_d_job);
  
/*!
 * Store the period time for task sender_testint
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (gr740_partition_sender_testint_k, &(period), 1, 50000, 0, sender_testint_job);
 ...
 * (gr740_partition_sender_trigger_k) the second is the period defined in 
 * the AADL model. Third is the task priority ( 1), fourth is the stack size
 *  ( 4500000 bytes) and last is the subprogram executed by the task
 */
  __po_hi_create_periodic_task (gr740_partition_sender_trigger_k, &(period), 1, 4500000, 0, sender_trigger_job);
