    ...
    (__po_hi_request_t* request)
{
  ...
  switch (request->port)
  {
    ...
    {
      __po_hi_gqueue_store_in (x86_partition_receiver_image_k, receiver_image_local_inport_image, request);
 ...
 */
  ...
  __po_hi_compute_next_period (x86_partition_receiver_image_k);
  
/*!
 * Waiting for the first dispatch instant
 */
  __po_hi_wait_for_next_period (x86_partition_receiver_image_k);
 ...
 */
  while (1)
  {
    __po_hi_gqueue_wait_for_incoming_event (x86_partition_receiver_image_k, &(port));
    __po_hi_compute_next_period (x86_partition_receiver_image_k);
    ...
    switch (port)
    {
      ...
      {
        /* :: Yes if commentary :: */
        if (__po_hi_gqueue_get_count (x86_partition_receiver_image_k, receiver_image_local_inport_image))
        {
                  __po_hi_gqueue_get_value (x86_partition_receiver_image_k, receiver_image_local_inport_image, &(inport_image_request));
          __po_hi_gqueue_next_value (x86_partition_receiver_image_k, receiver_image_local_inport_image);

        }

        call_receiver_image (x86_partition_receiver_image_k, inport_image_request->vars.receiver_image_global_inport_image.receiver_image_global_inport_image);
 ...
 */
  ...
  __po_hi_compute_next_period (x86_partition_sender_trigger_k);
  
/*!
 * Waiting for the first dispatch instant
 */
  __po_hi_wait_for_next_period (x86_partition_sender_trigger_k);
 ...
 */
  while (1)
  {
    ...
    call_sender_trigger (x86_partition_sender_trigger_k);
    /*  Send the OUT ports */
    error =
     __po_hi_send_output (x86_partition_sender_trigger_k, sender_trigger_global_outport_receiver_image);
    (void)error;
    __po_hi_wait_for_next_period (x86_partition_sender_trigger_k);
  }
}
    ...
    (__po_hi_request_t* request)
{
  ...
  switch (entity)
  {
    case x86_partition_receiver_image_k_entity:
    {
...
void __po_hi_main_initialize (void)
{
  ...
  __po_hi_gqueue_init (x86_partition_receiver_image_k, __po_hi_receiver_image_nb_ports, __po_hi_receiver_image_queue, __po_hi_receiver_image_fifo_size, __po_hi_receiver_image_first, __po_hi_receiver_image_offsets, __po_hi_receiver_image_woffsets, __po_hi_receiver_image_n_dest, __po_hi_receiver_image_destinations, __po_hi_receiver_image_used_size, __po_hi_receiver_image_history, __po_hi_receiver_image_recent, __po_hi_receiver_image_empties, __po_hi_receiver_image_total_fifo_size);
  __po_hi_gqueue_init (x86_partition_sender_trigger_k, __po_hi_sender_trigger_nb_ports, __po_hi_sender_trigger_queue, __po_hi_sender_trigger_fifo_size, __po_hi_sender_trigger_first, __po_hi_sender_trigger_offsets, __po_hi_sender_trigger_woffsets, __po_hi_sender_trigger_n_dest, __po_hi_sender_trigger_destinations, __po_hi_sender_trigger_used_size, __po_hi_sender_trigger_history, __po_hi_sender_trigger_recent, __po_hi_sender_trigger_empties, __po_hi_sender_trigger_total_fifo_size);
}
