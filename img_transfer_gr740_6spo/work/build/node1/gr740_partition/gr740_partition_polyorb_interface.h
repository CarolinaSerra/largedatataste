...
// Protected provided interfaces of function receiver
   ...
   extern void receiver_c(const char *IN_buf_varc, size_t size_IN_buf_varc);
   void pro_receiver_c(const char *IN_buf_varc, size_t size_IN_buf_varc);
...
// Protected provided interfaces of function sender
   ...
   extern void sender_d(const char *IN_buf_vard, size_t size_IN_buf_vard);
   void pro_sender_d(const char *IN_buf_vard, size_t size_IN_buf_vard);
...
void call_receiver_c (__po_hi_task_id, dataview__myinteger_buffer_impl *);
...
void call_sender_d (__po_hi_task_id, dataview__myinteger_buffer_impl *);
