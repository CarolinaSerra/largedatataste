...
#define __PO_HI_MY_NODE_NAME "x86_partition_k"
...
typedef enum
{
  x86_partition_receiver_image_k_entity = 0,
  x86_partition_sender_trigger_k_entity = 1,
  invalid_entity = -1
} __po_hi_entity_t;

typedef enum
{
  x86_partition_receiver_image_k = 0,
  x86_partition_sender_trigger_k = 1,
  invalid_task_id = -1
} __po_hi_task_id;
...
#define __PO_HI_TASKS_STACK 100000000
