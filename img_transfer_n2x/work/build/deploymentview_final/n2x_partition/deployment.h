...
#define __PO_HI_MY_NODE n2x_partition_k

#define __PO_HI_MY_NODE_NAME "n2x_partition_k"

#define __po_hi_receiver_image_nb_ports 1
...
typedef enum
{
  n2x_partition_receiver_image_k_entity = 0,
  n2x_partition_sender_trigger_k_entity = 1,
  invalid_entity = -1
} __po_hi_entity_t;

typedef enum
{
  n2x_partition_receiver_image_k = 0,
  n2x_partition_sender_trigger_k = 1,
  invalid_task_id = -1
} __po_hi_task_id;
...
typedef enum
{
  ...
  sender_trigger_global_outport_receiver_image = 1,
  invalid_port_t = -1,
...
#define __PO_HI_PORT_TYPE_CONTENT __po_hi_receiver_image_nb_ports, __po_hi_sender_trigger_nb_ports
